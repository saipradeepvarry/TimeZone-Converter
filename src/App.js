    ...
    <DndProvider backend={HTML5Backend}>
      <div className={`app-container ${isDarkMode ? 'dark-mode' : ''}`}>
        ...
        <div className="container">
          ...
          <DatePicker placeholder="Select Date" className='date-picker' selected={selectedDate} onChange={handleDateChange} />
        ...
        <footer className="footer">
          <div className="footer-icons">
            <a href="https://github.com/saipradeepvarry" aria-label="GitHub Profile" className="footer-link">
              <GitHubIcon size={30} />
            </a>
            <a href="mailto:saipradeepvarry79979@gmail.com" aria-label="Send Email" className="footer-link">
              <MailIcon size={30} />
            </a>
          </div>
          <motion.p
